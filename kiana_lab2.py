...
radius = int(input("Enter value for circle radius"))
...
print("\nExercise 5")
day_today = int(input("Enter number of today's day number"))
days_trip = int(input("Enter trip duration"))
day_number_of_week_after_trip = (day_today + days_trip) % 7
print(f"You trip starts on day {day_today}, lasts {days_trip} days. You are back on day {day_number_of_week_after_trip}.")
